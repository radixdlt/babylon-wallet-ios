...
//	}
	...
	func testAddition() throws {
		func doTest(lhs lhsDecimalString: String, rhs rhsDecimalString: String, expected expectedString: String) throws {
			...
			XCTAssertEqual(try lhs + rhs, expected)
		}
...
//		try doTest("1e+900", "1e-900")
	...
	func test_round_decimal() throws {
		func doTest(_ decimalString: String, divisibility: UInt, expected expectedString: String, line: UInt = #line) throws {
			...
			let actual = try decimal.rounded(decimalPlaces: divisibility)
	...
	func test_truncate_decimal() throws {
		func doTest(_ decimalString: String, divisibility: UInt, expected expectedString: String, line: UInt = #line) throws {
			let expected = try RETDecimal(value: expectedString)
			let decimal = try RETDecimal(value: decimalString)
			let actual = try decimal.truncated(decimalPlaces: divisibility)
			XCTAssertEqual(actual, expected, line: line)
		}
	...
	func test_format_decimal() throws {
		func doTest(_ decimalString: String, expected: String, line: UInt = #line) throws {
			...
			let decimal = try RETDecimal(value: decimalString)
			let actual = try decimal.formatted(locale: locale, totalPlaces: 8, useGroupingSeparator: false)
			XCTAssertEqual(actual, expected, line: line)
		}
		...
		try doTest("0.999999999", expected: "1")
		try doTest("0.099999999", expected: "0.1")
		try doTest("0.009999999", expected: "0.01")
		try doTest("0.000999999", expected: "0.001")
		try doTest("0.000099999", expected: "0.0001")
		try doTest("0.000009999", expected: "0.00001")
		try doTest("0.000000999", expected: "0.000001")
		try doTest("0.000000099", expected: "0.0000001")
	...
	func test_format_grouping_separator() throws {
		func doTest(_ bigDecimalString: String, expected: String, line: UInt = #line) throws {
			let locale = Locale(identifier: "en_US_POSIX")
			let decimal = try RETDecimal(value: bigDecimalString)
			let actual = try decimal.formatted(locale: locale, totalPlaces: 8, useGroupingSeparator: true)
			XCTAssertEqual(actual, expected, line: line)
		}
