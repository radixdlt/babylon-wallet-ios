...
final class EngineToolkitClientTests: TestCase {
	func test__derive_olympia_address_from_public_key() throws {
		...
		let bytes = try Bytes(hex: "03f43fba6541031ef2195f5ba96677354d28147e45b40cde4662bec9162c361f55").bytes
		let publicKey = try K1.PublicKey(rawRepresentation: bytes)
