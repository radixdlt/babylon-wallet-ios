...
extension AppPreferencesClient {
	static let previewApp: Self = with(noop) {
		...
		$0.getPreferences = {
			...
			let configJSONStrings = [bestFriend, instabridge, colleague]
			...
			"thresholdFactors" :  [
				 {
					...
					"securityQuestions" :  {
						"common" :  {
							...
							"id" : "5e5b89016c6c7460b1d572ddd2678a28a6ac864cf4b6727620e9f28d5ca33ebcb0",
		   ...
		   "thresholdFactors" :  [
				{
				   ...
				   "securityQuestions" :  {
					   "common" :  {
						   ...
						   "id" : "5eefb4e1a794af4c3ed440dc7926a974a247350c4f2f683d1d09c2f9a334c6345a",
						   "lastUsedOn" : "2023-06-12T13:39:09Z"
					   },
					   "sealedMnemonic" :  {
						   "encryptions" :  [
		   ...
		   "thresholdFactors" :  [
				{
				   ...
				   "trustedContact" :  {
					   "common" :  {
						   ...
						   "id" : "c00db6132d949d2cb6c09f2907f7711a3a6c74cc105750ae3830af1b6d9f5da053",
						   "lastUsedOn" : "2023-06-12T13:39:09Z"
					   },
					   "emailAddress" : "Recover@instabridge.io",
					   "name" : "InstaBridge"
				   }
			   }
		   ]
			...
			"thresholdFactors" :  [
				 {
					...
					"securityQuestions" :  {
						"common" :  {
							...
							"id" : "5e3590f933219d2f6fee54bd0573dde4033139c124dd110ad26657d0be9b8625b5",
			...
			"thresholdFactors" :  [
				 {
					...
					"trustedContact" :  {
						...
						"emailAddress" : "coworker@rdx.works",
						"name" : "Colleague"
					}
				}
			]
