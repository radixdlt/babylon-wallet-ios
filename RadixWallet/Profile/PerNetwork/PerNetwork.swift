...
extension Profile.Networks.Error {
	...
	public var _description: String {
		switch self {
		case let .unknownNetworkWithID(id): "Profile.Networks.Error.unknownNetworkWithID(\(id))"
		case let .networkAlreadyExistsWithID(id): "Profile.Networks.Error.networkAlreadyExistsWithID(\(id))"
		}
	}
}
