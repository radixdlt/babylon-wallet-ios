...
extension SLIP10.PublicKey {
	...
	public var curve: SLIP10.Curve {
		switch self {
		case .eddsaEd25519: .curve25519
		case .ecdsaSecp256k1: .secp256k1
		}
	}
...
extension SLIP10.PublicKey {
	public var compressedData: Data {
		switch self {
		case let .eddsaEd25519(key): key.compressedRepresentation
		case let .ecdsaSecp256k1(key): key.compressedRepresentation
		}
	}
}
