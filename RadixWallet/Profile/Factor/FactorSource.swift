...
extension FactorSource {
	...
	public var id: ID {
		...
		case let .offDeviceMnemonic(factorSource): factorSource.id.embed()
		case let .securityQuestions(factorSource): factorSource.id.embed()
		case let .trustedContact(factorSource): factorSource.id.embed()
		}
	}
	...
	private func property<Property>(_ keyPath: KeyPath<any BaseFactorSourceProtocol, Property>) -> Property {
		...
		case let .offDeviceMnemonic(factorSource): factorSource[keyPath: keyPath]
		case let .securityQuestions(factorSource): factorSource[keyPath: keyPath]
		case let .trustedContact(factorSource): factorSource[keyPath: keyPath]
		}
	}
}
