...
//
	////		public let id: ID
//		public let items: DappToWalletInteractionItems
//		public let metadata: DappToWalletInteractionMetadata
//
//		public init(items: DappToWalletInteractionItems, metadata: DappToWalletInteractionMetadata) {
//			self.items = items
