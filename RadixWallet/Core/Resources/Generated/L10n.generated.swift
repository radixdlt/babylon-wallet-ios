...
internal enum L10n {
  ...
  internal enum FactorSources {
    ...
    internal enum Detail {
      ...
      /// Manage public keys used for configuring authentication rules
      internal static let mfaSignatureResourceSubtitle = L10n.tr("Localizable", "factorSources_detail_mfaSignatureResourceSubtitle", fallback: "Manage public keys used for configuring authentication rules")
      /// MFA Signature Resources
      internal static let mfaSignatureResourceTitle = L10n.tr("Localizable", "factorSources_detail_mfaSignatureResourceTitle", fallback: "MFA Signature Resources")
      /// Seed Phrase Lost
  ...
  internal enum InfoLink {
    ...
    internal enum Glossary {
      ...
      /// 
      /// Your [Radix Wallet](?glossaryAnchor=radixwallet) will help you by suggesting a good Shield configuration once you’ve added the required security factors. Once this is done, you can edit it to suit your requirements. To guide you, the Radix Wallet provides 3 best-practice recommendations to ensure those edits don't make your Shield unsafe or innaccessible.
      /// 
      /// 1. It’s recommended that [Password](?glossaryAnchor=passwords) is not used alone. They are useful factors but aren't secure enough to be used by themselves.
      /// 2. To make sure you won't lose access if you lose 1 of your factors, it’s recommended to have at least 2 factor options to start a Shield recovery.
      /// 3. To make sure nobody can take away your Shield by stealing just 1 factor, if you are only using 1 factor for regular access, it’s best not to use that factor again for recovery. Also, the same factor should not be used both to start and confirm a recovery.
      /// 
