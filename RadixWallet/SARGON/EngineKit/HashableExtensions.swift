...
// MARK: - RETDecimal + Hashable
extension RETDecimal: Hashable {
	public func hash(into hasher: inout Hasher) {
...
// MARK: - EngineToolkitAddress + Hashable
extension EngineToolkitAddress: Hashable {
	public static func == (lhs: EngineToolkitAddress, rhs: EngineToolkitAddress) -> Bool {
