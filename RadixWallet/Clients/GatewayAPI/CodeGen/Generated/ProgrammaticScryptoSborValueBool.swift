...
@available(*, deprecated, renamed: "GatewayAPI.ProgrammaticScryptoSborValueBool")
typealias ProgrammaticScryptoSborValueBool = GatewayAPI.ProgrammaticScryptoSborValueBool

extension GatewayAPI {

struct ProgrammaticScryptoSborValueBool: Codable, Hashable {
    ...
    init(kind: ProgrammaticScryptoSborValueKind, typeName: String? = nil, fieldName: String? = nil, value: Bool) {
        self.kind = kind
