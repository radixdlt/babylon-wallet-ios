...
typealias TransactionPreviewRequestFlags = GatewayAPI.TransactionPreviewRequestFlags

extension GatewayAPI {

struct TransactionPreviewRequestFlags: Codable, Hashable {

    /** Whether to use a virtual, preview-only pool of XRD to pay for all execution fees.  */
    private(set) var useFreeCredit: Bool
    /** Whether the virtual signature proofs should be automatically placed in the auth zone.  */
    private(set) var assumeAllSignatureProofs: Bool
    ...
    private(set) var skipEpochCheck: Bool
    ...
    private(set) var disableAuthChecks: Bool?

    init(useFreeCredit: Bool, assumeAllSignatureProofs: Bool, skipEpochCheck: Bool, disableAuthChecks: Bool? = nil) {
