...
typealias StateEntityFungibleResourceVaultsPageRequest = GatewayAPI.StateEntityFungibleResourceVaultsPageRequest

extension GatewayAPI {

struct StateEntityFungibleResourceVaultsPageRequest: Codable, Hashable {
    ...
    init(atLedgerState: LedgerStateSelector? = nil, cursor: String? = nil, limitPerPage: Int? = nil, address: String, resourceAddress: String) {
