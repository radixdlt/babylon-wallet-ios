...
typealias BlueprintRoyaltyConfig = GatewayAPI.BlueprintRoyaltyConfig

extension GatewayAPI {

struct BlueprintRoyaltyConfig: Codable, Hashable {

    private(set) var isEnabled: Bool
    /** The royalty rules by method. The array is only present if royalties are enabled. */
    private(set) var methodRules: [BlueprintMethodRoyalty]?

    init(isEnabled: Bool, methodRules: [BlueprintMethodRoyalty]? = nil) {
