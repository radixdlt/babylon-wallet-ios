...
typealias StateAccountLockerPageVaultsResponse = GatewayAPI.StateAccountLockerPageVaultsResponse

extension GatewayAPI {

struct StateAccountLockerPageVaultsResponse: Codable, Hashable {
    ...
    init(ledgerState: LedgerState, totalCount: Int64? = nil, nextCursor: String? = nil, items: [AccountLockerVaultCollectionItem], lockerAddress: String, accountAddress: String) {
