...
typealias StateAccountResourcePreferencesPageResponse = GatewayAPI.StateAccountResourcePreferencesPageResponse

extension GatewayAPI {

struct StateAccountResourcePreferencesPageResponse: Codable, Hashable {
    ...
    init(ledgerState: LedgerState, totalCount: Int64? = nil, nextCursor: String? = nil, items: [AccountResourcePreferencesResponseItem], accountAddress: String) {
