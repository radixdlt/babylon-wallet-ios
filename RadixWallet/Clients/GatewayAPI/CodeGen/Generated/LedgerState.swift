...
typealias LedgerState = GatewayAPI.LedgerState
...
struct LedgerState: Codable, Hashable {
    ...
    private(set) var proposerRoundTimestamp: String
    ...
    init(network: String, stateVersion: Int64, proposerRoundTimestamp: String, epoch: Int64, round: Int64) {
