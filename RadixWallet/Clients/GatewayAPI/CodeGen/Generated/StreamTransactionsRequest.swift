...
typealias StreamTransactionsRequest = GatewayAPI.StreamTransactionsRequest

extension GatewayAPI {

struct StreamTransactionsRequest: Codable, Hashable {

    enum KindFilter: String, Codable, CaseIterable {
        case user = "User"
    ...
    private(set) var kindFilter: KindFilter?
    ...
    private(set) var manifestAccountsWithdrawnFromFilter: [String]?
    ...
    private(set) var manifestAccountsDepositedIntoFilter: [String]?
    ...
    private(set) var manifestBadgesPresentedFilter: [String]?
    ...
    private(set) var manifestResourcesFilter: [String]?
    ...
    private(set) var affectedGlobalEntitiesFilter: [String]?
    ...
    private(set) var eventsFilter: [StreamTransactionsRequestEventFilterItem]?
    ...
    private(set) var accountsWithManifestOwnerMethodCalls: [String]?
    ...
    private(set) var accountsWithoutManifestOwnerMethodCalls: [String]?
    private(set) var manifestClassFilter: StreamTransactionsRequestAllOfManifestClassFilter?
    ...
    private(set) var eventGlobalEmittersFilter: [String]?
    /** Configures the order of returned result set. Defaults to `desc`. */
    private(set) var order: Order?
    private(set) var optIns: TransactionDetailsOptIns?

    init(atLedgerState: LedgerStateSelector? = nil, fromLedgerState: LedgerStateSelector? = nil, cursor: String? = nil, limitPerPage: Int? = nil, kindFilter: KindFilter? = nil, manifestAccountsWithdrawnFromFilter: [String]? = nil, manifestAccountsDepositedIntoFilter: [String]? = nil, manifestBadgesPresentedFilter: [String]? = nil, manifestResourcesFilter: [String]? = nil, affectedGlobalEntitiesFilter: [String]? = nil, eventsFilter: [StreamTransactionsRequestEventFilterItem]? = nil, accountsWithManifestOwnerMethodCalls: [String]? = nil, accountsWithoutManifestOwnerMethodCalls: [String]? = nil, manifestClassFilter: StreamTransactionsRequestAllOfManifestClassFilter? = nil, eventGlobalEmittersFilter: [String]? = nil, order: Order? = nil, optIns: TransactionDetailsOptIns? = nil) {
