...
typealias FungibleResourcesCollection = GatewayAPI.FungibleResourcesCollection
...
struct FungibleResourcesCollection: Codable, Hashable {
    ...
    init(totalCount: Int64? = nil, nextCursor: String? = nil, items: [FungibleResourcesCollectionItem]) {
