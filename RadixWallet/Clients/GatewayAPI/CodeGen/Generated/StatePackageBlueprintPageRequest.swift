...
typealias StatePackageBlueprintPageRequest = GatewayAPI.StatePackageBlueprintPageRequest

extension GatewayAPI {

struct StatePackageBlueprintPageRequest: Codable, Hashable {
    ...
    init(atLedgerState: LedgerStateSelector? = nil, cursor: String? = nil, limitPerPage: Int? = nil, packageAddress: String) {
