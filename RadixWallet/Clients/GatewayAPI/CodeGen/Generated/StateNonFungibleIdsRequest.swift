...
typealias StateNonFungibleIdsRequest = GatewayAPI.StateNonFungibleIdsRequest

extension GatewayAPI {

struct StateNonFungibleIdsRequest: Codable, Hashable {
    ...
    init(atLedgerState: LedgerStateSelector? = nil, cursor: String? = nil, limitPerPage: Int? = nil, resourceAddress: String) {
