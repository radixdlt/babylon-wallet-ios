...
typealias TransactionStatusResponse = GatewayAPI.TransactionStatusResponse
...
struct TransactionStatusResponse: Codable, Hashable {
    ...
    private(set) var intentStatus: TransactionIntentStatus
    /** An additional description to clarify the intent status.  */
    private(set) var intentStatusDescription: String
    private(set) var knownPayloads: [TransactionStatusResponseKnownPayloadItem]
    /** If the intent was committed, this gives the state version when this intent was committed.  */
    private(set) var committedStateVersion: Int64?
    ...
    private(set) var permanentlyRejectsAtEpoch: Int64?
    ...
    init(ledgerState: LedgerState, status: TransactionStatus, intentStatus: TransactionIntentStatus, intentStatusDescription: String, knownPayloads: [TransactionStatusResponseKnownPayloadItem], committedStateVersion: Int64? = nil, permanentlyRejectsAtEpoch: Int64? = nil, errorMessage: String? = nil) {
