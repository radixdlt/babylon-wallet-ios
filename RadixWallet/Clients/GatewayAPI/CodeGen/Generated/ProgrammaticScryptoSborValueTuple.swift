...
typealias ProgrammaticScryptoSborValueTuple = GatewayAPI.ProgrammaticScryptoSborValueTuple

extension GatewayAPI {

struct ProgrammaticScryptoSborValueTuple: Codable, Hashable {
    ...
    private(set) var fields: [ProgrammaticScryptoSborValue]

    init(kind: ProgrammaticScryptoSborValueKind, typeName: String? = nil, fieldName: String? = nil, fields: [ProgrammaticScryptoSborValue]) {
        self.kind = kind
