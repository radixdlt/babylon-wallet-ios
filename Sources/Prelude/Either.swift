...
public enum Either<Left, Right> {
	...
	public var left: Left? {
		self.either(ifLeft: Optional.some, ifRight: { _ in Optional.none })
	}

	public var right: Right? {
		self.either(ifLeft: { _ in Optional.none }, ifRight: Optional.some)
	}
...
extension Either where Left: Error {
	public var asRightResult: Result<Right, Left> {
		self.either(ifLeft: Result.failure, ifRight: Result.success)
	}
}

extension Either where Right: Error {
	public var asLeftResult: Result<Left, Right> {
		self.either(ifLeft: Result.success, ifRight: Result.failure)
	}
}
