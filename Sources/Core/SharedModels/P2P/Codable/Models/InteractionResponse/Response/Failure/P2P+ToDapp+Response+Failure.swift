...
public extension P2P.ToDapp.Response {
	struct Failure: Sendable, Hashable, Encodable, Identifiable {
		...
		public static func rejected(_ request: P2P.FromDapp.WalletInteraction) -> Self {
			Self(id: request.id, kind: .rejectedByUser, message: nil)
		}

		public static func request(_ request: P2P.FromDapp.WalletInteraction, failedWithError error: Kind.Error, message: String?) -> Self {
