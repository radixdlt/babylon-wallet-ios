...
public typealias AlertActionOf<T> = PresentationAction<AlertState<T>, T>

public typealias AlertStoreOf<T> = Store<PresentationState<AlertState<T>>, AlertActionOf<T>>
