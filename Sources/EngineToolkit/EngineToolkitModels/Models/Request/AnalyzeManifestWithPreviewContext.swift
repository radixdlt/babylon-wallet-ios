...
public extension AccountDeposit {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .Exact(let componentAddress, let resourceSpecifier):
        ...
        case .Estimate(let index, let componentAddress, let resourceSpecifier):
