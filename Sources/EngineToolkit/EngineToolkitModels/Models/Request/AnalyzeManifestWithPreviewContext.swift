...
public struct AnalyzeManifestWithPreviewContextResponse: Codable, Sendable, Hashable {
...
public struct EncounteredAddresses: Codable, Sendable, Hashable {
...
public struct EncounteredComponents: Codable, Sendable, Hashable {
...
public struct AccountWithdraw: Codable, Sendable, Hashable {
...
// MARK: - AccountDeposit
public enum AccountDeposit: Codable, Sendable, Hashable {
	case exact(
...
public enum ResourceSpecifier: Codable, Sendable, Hashable {
