...
extension GatewayAPIClient: TestDependencyKey {
	...
	public static let testValue = Self(
		...
		getEntityFungibleResourceVaultPage: unimplemented("\(Self.self).getEntityFungibleResourceVaultPage"),
		getAccountNonFungibleIdsPageRequest: unimplemented("\(Self.self).getAccountNonFungibleIdsPageRequest"),
