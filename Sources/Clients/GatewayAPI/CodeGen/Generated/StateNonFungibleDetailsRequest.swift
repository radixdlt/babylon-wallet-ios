...
@available(*, deprecated, renamed: "GatewayAPI.StateNonFungibleDetailsRequest")
public typealias StateNonFungibleDetailsRequest = GatewayAPI.StateNonFungibleDetailsRequest

// MARK: - GatewayAPI.StateNonFungibleDetailsRequest
extension GatewayAPI {
	public struct StateNonFungibleDetailsRequest: Codable, Hashable {
		...
		public init(atLedgerState: LedgerStateSelector? = nil, cursor: String? = nil, limitPerPage: Int? = nil, resourceAddress: String, nonFungibleIds: [String]) {
