...
// MARK: - GatewayAPI.StateEntityFungiblesPageResponse
extension GatewayAPI {
	public struct StateEntityFungiblesPageResponse: Codable, Hashable {
		...
		public init(ledgerState: LedgerState, totalCount: Int64? = nil, previousCursor: String? = nil, nextCursor: String? = nil, items: [FungibleResourcesCollectionItem], address: String) {
