...
@available(*, deprecated, renamed: "GatewayAPI.PartialLedgerStateIdentifier")
public typealias PartialLedgerStateIdentifier = GatewayAPI.PartialLedgerStateIdentifier

// MARK: - GatewayAPI.PartialLedgerStateIdentifier
public extension GatewayAPI {
	/** Allows a client to request a response referencing an earlier (&#x60;at_*&#x60; properties) or later (&#x60;from_*&#x60; properties) ledger state. */
	struct PartialLedgerStateIdentifier: Codable, Hashable {
