...
public struct StateEntityNonFungibleIdsPageResponse: Codable, Hashable {
    ...
    public init(ledgerState: LedgerState, totalCount: Int64? = nil, previousCursor: String? = nil, nextCursor: String? = nil, items: [String], address: String, resourceAddress: String) {
