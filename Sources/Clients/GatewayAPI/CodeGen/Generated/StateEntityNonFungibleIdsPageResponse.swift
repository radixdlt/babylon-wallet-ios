...
@available(*, deprecated, renamed: "GatewayAPI.StateEntityNonFungibleIdsPageResponse")
public typealias StateEntityNonFungibleIdsPageResponse = GatewayAPI.StateEntityNonFungibleIdsPageResponse

// MARK: - GatewayAPI.StateEntityNonFungibleIdsPageResponse
extension GatewayAPI {
	public struct StateEntityNonFungibleIdsPageResponse: Codable, Hashable {
		...
		public init(ledgerState: LedgerState, totalCount: Int64? = nil, previousCursor: String? = nil, nextCursor: String? = nil, items: [NonFungibleIdsCollectionItem], address: String, resourceAddress: String) {
