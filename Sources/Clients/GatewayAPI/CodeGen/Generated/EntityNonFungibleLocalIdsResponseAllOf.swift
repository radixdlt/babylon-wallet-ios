...
extension GatewayAPI {
	public struct EntityNonFungibleLocalIdsResponseAllOf: Codable, Hashable {
		...
		public init(address: String, resourceAddress: String, nonFungibleIds: NonFungibleLocalIdsCollection) {
