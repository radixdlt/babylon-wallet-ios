...
extension GatewayAPI {
	public struct StateEntityDetailsResponseComponentDetails: Codable, Hashable {
		...
		public init(type: StateEntityDetailsResponseItemDetailsType, packageAddress: String, blueprintName: String, state: AnyCodable? = nil, accessRulesChain: AnyCodable, royaltyAggregator: FungibleResourcesCollectionItemGloballyAggregated? = nil) {
			self.type = type
