// FROM: https://github.com/apple/swift-algorithms/blob/195e0316d7ba71e134d0f6c677f64b4db6160c46/Sources/Algorithms/Chunked.swift
// LICENSE: Apache 2.0: https://github.com/apple/swift-algorithms/blob/main/LICENSE.txt

// MARK: - ChunkedByCollection
...
// MARK: - ChunkedByCollection.Index + Hashable
extension ChunkedByCollection.Index: Hashable where Base.Index: Hashable {}

// MARK: - ChunkedByCollection + BidirectionalCollection
...
// MARK: - ChunkedByCollection + LazyCollectionProtocol
extension ChunkedByCollection: LazyCollectionProtocol {}

// MARK: - ChunkedOnCollection
/// A collection wrapper that breaks a collection into chunks based on a
/// predicate.
///
...
// MARK: - ChunksOfCountCollection.Index + Comparable
...
// MARK: - ChunksOfCountCollection + BidirectionalCollection, RandomAccessCollection
...
// MARK: - ChunksOfCountCollection.Index + Hashable
extension ChunksOfCountCollection.Index: Hashable where Base.Index: Hashable {}

// MARK: - ChunksOfCountCollection + LazySequenceProtocol, LazyCollectionProtocol
